...
let creation_de_compte_demande_confirme ~prenom ~nom ~login ~lien_confirm  () = Printf.sprintf "<html lang=\"fr\"><head> 
        <meta charset=\"utf-8\">
...
let creation_de_compte_cree_par_autre_confirmation ~prenom ~nom ~prenom_createur ~nomcreateur ~login ~lien_confirm  () = Printf.sprintf "<html lang=\"fr\"><head> 
        <meta charset=\"utf-8\">
        <title>email d'activation de compte</title>
        <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">
        <meta name=\"description\" content=\"\">
