...
let write_createFolder : _ -> createFolder -> _ = (
  fun ob x ->
...
let string_of_createFolder ?(len = 1024) x =
  let ob = Bi_outbuf.create len in
  write_createFolder ob x;
  Bi_outbuf.contents ob
let read_createFolder = (
  fun p lb ->
...
let createFolder_of_string s =
  read_createFolder (Yojson.Safe.init_lexer ()) (Lexing.from_string s)
